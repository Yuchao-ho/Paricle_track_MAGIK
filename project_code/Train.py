...
if __name__ == "__main__":
    trainer = tracker_train(
        ...
        len_frame_sim= 1000, num_frame_sim= 80, 
        D_sim= 0.1, max_gap= 4, prob_noise= 0.05, prop_steady= 0.4
    )

    trainer(
        window_size= 6, data_size= 624, batch_size=30, max_epochs= 30, 
        particle_feature_path= "/home/user/Project_thesis/Particle_Hana/Cell7__ground_truth/particle_fea(std_intens).csv", 
        checkpoint_pth= "/home/user/Project_thesis/Particle_Hana/Cell7__ground_truth/model_(Consec(dist), num=100, gap=4).pt"
    )